  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        ...
        <header class="bg-lightBg-h">
  <div
    class="mx-auto flex justify-between h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8"
  >
    <a class="block text-red-700 text-xl tracking-[8px] leading-3 bg-btnColor p-3" href="/">
      LOGO
    </a>

    <div class="flex flex-1 items-center align-middle justify-end md:justify-between">
    <div class="flex items-center gap-4">
